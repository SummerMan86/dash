/**
 * Payment Analytics fixtures (shared).
 *
 * Used by:
 * - demo UI pages
 * - mockProvider in server layer
 *
 * Keep this file dependency-free (types + plain data).
 *
 * For beginners:
 * - fixtures are "fake data" used to build and test the UI without a database.
 * - later, Oracle/Postgres/Cube providers will return the same *shape* of data.
 */

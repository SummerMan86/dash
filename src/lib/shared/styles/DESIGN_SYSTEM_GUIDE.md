...
bg-card hover:bg-card-hover text-card-foreground border-card-border
bg-popover text-popover-foreground border-popover-border
bg-sidebar hover:bg-sidebar-hover text-sidebar-foreground
...
<Skeleton class="h-72 w-full" /> <!-- Chart placeholder -->
```
...
const barOptions = {
  ...
  series: [
    { ...getBarSeries(1), data: [100, 200, 150] }
  ]
};

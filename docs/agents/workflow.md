...
### 2.4. Stabilization governance loop (`baseline-governor`)
...
3. Проверяет:
   ...
   - у каждого live exception есть ли owner и expiry
4. Выносит verdict:
   - `baseline not closed`
...
| `emis_known_exceptions.md` | baseline-governor / lead-strategic | все роли по необходимости |

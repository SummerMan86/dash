...
- Contract-touching docs closed (unresolved gaps block wave closure per §3.8); any pre-existing navigation `AGENTS.md` drift outside the wave's touched directories carried over with owner + expiry

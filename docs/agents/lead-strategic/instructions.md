...
При закрытии feature/initiative — проверь Feature DoD из `docs/agents/review-gate.md` §4.3.
...
Named passes within `lead-strategic`, not separate agents. Lifecycle: `docs/agents/review-gate.md`.

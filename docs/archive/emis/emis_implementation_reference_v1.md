# EMIS Implementation Reference v1

## 1. Архивная роль документа

Этот документ сохранен как historical reference по v1-реализации EMIS.
Он больше не является активным implementation spec и не владеет current-state ownership, placement rules или live backlog.

Если нужен current truth, читать:

- [EMIS Session Bootstrap](../../emis_session_bootstrap.md)
- [Architecture](../../architecture.md)
- [EMIS Working Contract](../../emis_working_contract.md)

Если нужен product scope, читать:

- [EMIS MVE Product Contract](../../emis_mve_product_contract.md)

Ниже сохранены retained implementation decisions, API/data assumptions и historical rollout order.
...
- current ownership и placement rules читать в:
  ...
  - [Architecture](../../architecture.md)
  - [EMIS Working Contract](../../emis_working_contract.md)
- этот reference больше не является current ownership map
...
Этот reference фиксирует retained implementation decisions, structure assumptions и rollout order.
...
- актуальный status и practical focus смотреть в `../../emis_session_bootstrap.md`
...
## 18. Как использовать reference вместе с current docs

...
<SidebarProvider>
	...
	<div class="min-h-screen lg:flex">
		<Sidebar>
			<div class="px-3 pt-4">
				<div class="type-overline mb-3 px-3 text-sidebar-muted">NAVIGATION</div>
			</div>
			...
			<div class="min-h-screen bg-background p-6 lg:p-8">
				...
				<header class="mb-8">
                   ...
                   - desktop: показывает/скрывает левую колонку -->
							...
							<div>
								<h1 class="type-page-title">Payment Analytics</h1>
						...
						<div class="flex items-center gap-3">
							<span class="type-badge rounded-md bg-accent/10 px-3 py-1.5 text-accent"> Live </span>
							<span class="type-body-sm text-muted-foreground">
								{currentDate}
							</span>
						</div>
					</div>
              ...
              - `lg`: 5 колонок -->
				...
				<section class="mb-8">
					...
					<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
						...
						<div>
							<ChartCard title="Category Split" subtitle="By MCC code" {loading}>
				...
				<footer class="mt-12 border-t border-border/50 pt-6">
					<div class="type-caption flex items-center justify-center text-muted-foreground">
